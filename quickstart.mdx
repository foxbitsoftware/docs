...
<CardGroup cols={2}>
  ...
  <Card title="Add environement variables" icon="square-code" href="/advanced/environments">
    Include syntax-highlighted code blocks.
  </Card>
  <Card title="Add additional verified email addresses" icon="at" href="/advanced/emails">
